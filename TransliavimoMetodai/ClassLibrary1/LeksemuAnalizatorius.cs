...
namespace TM.SintaksinisAnalizatorius
{
    ...
    public class DeklaravimoAnal : ILeksemuAnalizatorius
    {
        ...
        public string Analyze(SintaksinisAnalizatorius analizatorius, Guid tevoId)
        {
            ...
            while (analizatorius.VarduLentele[analizatorius.Indeksas].Reiksme != "{")
            {
                ...
                if (!rado)
                {
                    throw new SyntaxException("incorrect declaration: " + analizatorius.VarduLentele[analizatorius.Indeksas].Reiksme);
                }
            }
    ...
    public class MasyvoDeklaravimoAnal : ILeksemuAnalizatorius
    {
        ...
        public string Analyze(SintaksinisAnalizatorius analizatorius, Guid tevoId)
        {
            ...
            {
                throw new SyntaxException("integer expected " + analizatorius.VarduLentele[analizatorius.Indeksas].Reiksme + " found");
            }
            ...
            {
                throw new SyntaxException("identifikatorius expected " + analizatorius.VarduLentele[analizatorius.Indeksas].Reiksme + " found");
            }
    ...
    public class FunkcijosDeklaravimoAnal : ILeksemuAnalizatorius
    {
        ...
        public string Analyze(SintaksinisAnalizatorius analizatorius, Guid tevoId)
        {
            ...
            {
                throw new SyntaxException("returns expected " + analizatorius.VarduLentele[analizatorius.Indeksas].Reiksme + " found");
            }
            analizatorius.Indeksas++;
    ...
    public class TipasAnal : ILeksemuAnalizatorius
    {
        ...
        public string Analyze(SintaksinisAnalizatorius analizatorius, Guid tevoId)
        {
            ...
            if (index == -1)
            {
                throw new SyntaxException("tipas expected " + analizatorius.VarduLentele[analizatorius.Indeksas].Reiksme +
                                        " found");
            }
            else
            {
        ...
        public string Analyze(SintaksinisAnalizatorius analizatorius, Guid tevoId)
        {
            ...
            while (analizatorius.VarduLentele[analizatorius.Indeksas].Reiksme != ")")
            {
                ...
                if (analizatorius.VarduLentele[analizatorius.Indeksas].Reiksme != ")")
                {
                    ...
                    {
                        throw new SyntaxException(", expected " + analizatorius.VarduLentele[analizatorius.Indeksas].Reiksme +
                                            " found");
                    }
                }
            }
